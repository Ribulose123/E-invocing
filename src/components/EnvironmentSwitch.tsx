  ...
  return (
    <div className="relative group">
      <button
        ...
        onClick={handleClick}
        className={cn(
          "relative inline-flex h-9 w-36 sm:w-40 items-center rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 px-1",
          isProduction ? "bg-secondary" : "bg-slate-200",
          className
        )}
      >
        <span
          ...
          isProduction ? "translate-x-[calc(100%+0.25rem)] text-primary" : "translate-x-0 text-slate-600"
          )}
        >
          {displayText}
        </span>
